            ...
            <div className="w-full"> 
              ...
              <div className="mt-8 mb-12 p-6 bg-card text-card-foreground rounded-xl shadow-lg border border-border max-w-2xl mx-auto">
                  ...
                  <p className="text-sm leading-relaxed text-muted-foreground">
                    このサイトはカレンダーとして，滋賀県を中心に，その周辺の魅力的なイベントや、家族で楽しめるスポット情報を集約しています。 情報は随時更新していき、あなたにぴったりのイベントを簡単に見つけられるようなサイトにしていきます．週末のおでかけ先などにご活用ください！
                  </p>
                <p className="text-sm leading-relaxed text-muted-foreground">
                  注意点:ウェブサイトが重くなるのを避けるため，終了したイベントについては削除していきます．ご了承下さい．
                </p>
                <p className="text-sm leading-relaxed text-muted-foreground">
                  注意点：チェックを心掛けていますが，誤った情報を提供してしまう可能性があります．詳細をお確かめください．
                </p>
              </div>
              </div>
            )}
